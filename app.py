...
#global vars
db_uri = 'mysql://corepay:18781875Core@localhost:3306/corepay_btc'
...
def create_wallet():
    ...
    w = Wallet.create(name, keys=passphrase, network='testnet', db_uri=db_uri, owner=owner)
...
def send_to():
    ...
    #open wallet
    w = Wallet(wallet_name,db_uri=db_uri)
    t = t = w.send_to(reciever_address, '0.000 tBTC',network='testnet',offline=True)
